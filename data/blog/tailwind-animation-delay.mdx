---
title: 'Tailwind CSS 动态生成 animation-delay 实用类'
date: 2025-11-15
tags: ['Tailwind CSS', 'CSS', '动画', '前端技巧']
summary: 利用 Tailwind CSS 的 matchUtilities 动态生成 animation-delay 实用类，让动画配置更灵活、组件复用更自然。
---
