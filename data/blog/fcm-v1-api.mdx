---
title: 'FCM 迁移 HTTP v1 API：鉴权、发送与避坑'
date: 2026-01-10
tags: ['FCM', 'Firebase', 'Node.js', 'HTTP v1 API']
summary: 记录 Firebase Cloud Messaging 从旧版接口迁移到 HTTP v1 API 的关键步骤、鉴权方式，以及迁移过程中常见的报错与处理方式。
---
