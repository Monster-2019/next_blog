...
title: 'Fetch封装'
date: 2022-08-26
tags: ['Javascript', 'Fetch', 'Promise']
summary: 随着浏览器的更新迭代，对 fetch 和 Promise 的支持也越来越好，在一些需求小或者无兼容需求的项目引入请求库无疑是浪费资源的，而原生支持的 fetch 就为我们提供了另一条路，下面针对 fetch 和 API 规范做封装
---
