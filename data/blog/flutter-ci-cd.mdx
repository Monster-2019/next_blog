---
title: 'Flutter App CI/CD 实战：用 GitHub Actions 自动构建与发布'
date: 2026-02-21
tags: ['Flutter', 'GitHub Actions', 'CI/CD', '自动化部署']
summary: 结合 GitHub Actions 打造 Flutter 应用的自动构建、签名与分发流程，减少手动发布成本并提升交付效率。
---
