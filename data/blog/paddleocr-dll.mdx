---
title: 'Windows 编译 PaddleOCR DLL：给 Python 调用的完整流程'
date: 2025-12-06
tags: ['PaddleOCR', 'OCR', 'Windows', 'DLL', 'Python']
summary: 记录在 Windows 平台将 PaddleOCR 编译为 DLL，并供 Python 调用时的关键步骤、依赖处理与注意事项。
---
